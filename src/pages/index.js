      ...
      <div className="grow shrink-0 w-[500px]">
        <div className="pt-5">
          ...
          <input
            ...
            onChange={descriptionChange} className="shadow pb-2 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" />
                    {todo.isEditing ? (
    ...
    return (
      <li className="text-lg pt-5 flex" key={index}>
        ...
        <div>
          ...
          <button onClick={() => handleTodoDone(index)} className="mt-3 ml-4 shadow bg-green-500 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
            Done
          </button>
        </div>
      </li>
